...
def generate_meeting_invite(data):
    ...
    try:
        ...
        print("required format:start date",start_date1.isoformat() + "Z")
        print(end_date)
        end_date1 = datetime.datetime.strptime(end_date, "%Y-%m-%d")
        print("required format:end date",end_date1.isoformat() + "Z")
        print(start_time)
        print(end_date)
        print(end_time)
        print(subject)
        ...
        print(join_url)
        meeting_invite= {"meeting_id": meeting_id,"meeting_password": meeting_password,"subject": subject,"start_date": start_date,"end_date": end_date,"start_time": start_time,"end_time": end_time,"join_url": join_url,
                    }
