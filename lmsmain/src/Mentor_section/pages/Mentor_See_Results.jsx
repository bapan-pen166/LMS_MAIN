...
const Mentor_See_Results = () => {
  ...
  const [mantorEmail,setMentorEmail] = useState();
  ...
  //  },[])
   ...
   const getAllResults =()=>{
        //  const data=userType=="Mentor"?{email:mantorEmail,adminUploadFlag:2}:{adminUploadFlag:1};
        const data=userType=="Mentor"?{email:mantorEmail,adminUploadFlag:2}:userType=="Mentor_Assistant"?{email:mantorEmail,adminUploadFlag:2}:{adminUploadFlag:1}
         axios.post(`${api}/mentor/getBatchStudentTests`,data)
         .then((Response)=>{
