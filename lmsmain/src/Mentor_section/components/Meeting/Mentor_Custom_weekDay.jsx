...
function Mentor_Custom_weekDay({ handleWeekDaysOpen, handleWeekDaysClose, selectedWeekDays, setSelectedWeekDays, WeekDaysopen }) {
    const daysOfWeek=[
        {Symbol:'S', DayNo:0, Day:'Sunday'},
        {Symbol:'M', DayNo:1, Day:'Monday'},
        {Symbol:'T', DayNo:2, Day:'Tuesday'},
...
export default Mentor_Custom_weekDay;
