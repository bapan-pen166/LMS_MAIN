...
const Mentor_Monthlymeetschedule = ({selectedNumber, setSelectedNumber,selectedFrequency, setSelectedFrequency,handleNumberChange,handleFrequencyChange, openmonthly, handleCloseMonthly }) => {
...
export default Mentor_Monthlymeetschedule;
