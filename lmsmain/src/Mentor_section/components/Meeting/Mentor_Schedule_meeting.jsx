...
// import Custom_Dlt_Menu from '/Mentor_Custom_Dlt_Menu';
import Custom_Dlt_Menu from "../Meeting/Mentor_Custom_Dlt_Menu"
...
function Mentor_Schedule_meeting({ meeting, setMeeting, holidaylist }) {
    ...
    function AgendaEvent({ event }) {
        ...
        const handleJoin = (meetlink, id, firstName,lastName) => {
                ...
                <>
                    <div className='event-container'>
                        ...
                        <button type='button' className='btn btn-success' onClick={() => {
                            handleJoin(event.meetingLink, event.meeting_id,firstName,lastName)
...
export default Mentor_Schedule_meeting;
