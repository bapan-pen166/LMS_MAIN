...
function Join_meeting({showJoinMeet,handleCloseJoinMeet,meetinfo}) {
              ...
              <div className='container-fluid'>
                <div className='row'>
                    <div className='col-md-12 d-flex justify-content-center align-items-center'>
                        ...
                        //  onClick={()=>{handleMeeting(meetinfo?.id)}}
                        onClick={()=>{handleMeeting(meetinfo?.meetlink,meetinfo?.firstName,meetinfo?.lastName,meetinfo?.userID)}}
                         >Join Meeting</button>
                    </div>
