    ...
    /*
         <div className="container mt-4">
                        <div className="search-box row justify-content-center">
                            <div className="col-md-8 d-flex align-items-center for-the-icon">
                                <input type="text" className="form-control" placeholder='Search here' value={searchquery} onChange={inputChange} />
                                <div className='mb-3 outer-searchicon'>
                                    <CiSearch className="ml-0 search-btn" />
                    ...
                    <div className='container-fluid pr-2 pl-2' style={{ minHeight: '100vh' }}>
                        <div className='d-flex small-screen'>
                            <div className='col-md-6 col-lg-6 col-sm-5' style={{ paddingLeft: '0px' }}>
                                <select className="form-select col-sm-12 col-md-12 mb-3 mt-1" aria-label="Default select example" onChange={handleCourseChange}>
                                    ...
                                    course.map((data)=>{
                                        console.log(data)
                                      return ( <>
                                        <option value={data.Course}>One</option>
                                        </>)
                                    })
                                }
                            ...
                            <div className='col-md-6 col-lg-6 col-sm-5' style={{ paddingRight: '0px' }}>
                                <select className="form-select small-fit col-sm-12 col-md-12 mb-3 mt-1" aria-label="Default select example" value={JSON.stringify(status)} onChange={handleStatusChange}>
                            ...
                            <div className='col-md-12 col-lg-12 scroll' style={{ paddingRight: '0px', paddingLeft: '0px' }}>
                                <table className="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            studentList?.length > 0 && studentList?.map((val) => {
                                                return (
                                                    <tr>
                                                        <td style={{ fontSize: '14px' }}>{val?.Name}</td>
                                                        <td style={{ fontSize: '14px' }}>{val?.Course}</td>
                                                        <td style={{ fontSize: '14px' }}>{val?.Batch}</td> 
                                                        ...
                                                        <td className='d-flex' style={{ border: 'none' }}>
                                                            <button style={{ background: 'transparent', border: 'none' }} onClick={() => { handleStudentEmail(val?.emailID) }}><i class='fa fa-reply' style={{ color: 'rgb(212, 139, 2)', fontSize: "14pt", padding: '2px' }}></i></button>
                                                            ...
                                                            ><i class="fa fa-edit" style={{ color: 'rgb(212, 139, 2)', fontSize: "14pt", padding: '2px' }}></i></button>
                                                        </td>
                                                    </tr>
                                                )
                                            })
    ...
    return (
        <>
            ...
            <div className='row content-body' >
                ...
                <div className="container-fluid mt-4 ml-2 m-r-2">
                                    ...
                                    {Array.isArray(studentList) && studentList.length > 0 && studentList?.map((val) => {
                                        return (
                                            <tr>
                                                ...
                                                <td className='d-flex' style={{ border: 'none' }}>
                                                    <button style={{ background: 'transparent', border: 'none' }} className='custom-button' onClick={() => { handleStudentEmail(val?.emailID) }} title='Send Link'><i className='fa fa-reply custom-icon' style={{ color: 'rgb(212, 139, 2)', fontSize: "14pt", padding: '2px' }}></i></button>
                                                    ...
                                                    <button disabled={val?.batch} onClick={() => updateBatch(val?.emailID)} style={{ background: 'transparent', border: 'none' }} className='custom-button' title='Save'><i class="fa fa-save custom-icon" style={{ color: 'rgb(212, 139, 2)', fontSize: "14pt", padding: '2px' }}></i></button>
                                                </td>
                                            </tr>
                                        )
                                    })}
          ...
          escape key. */}
                    <div className='row '>
                        ...
                        <div className="col-md-3 subheading" style={{paddingLeft:'54px'}}>
                        General Info
                        </div>
