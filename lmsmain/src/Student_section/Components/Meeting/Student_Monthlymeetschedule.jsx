...
const Student_Monthlymeetschedule = ({selectedNumber, setSelectedNumber,selectedFrequency, setSelectedFrequency,handleNumberChange,handleFrequencyChange, openmonthly, handleCloseMonthly }) => {
...
export default Student_Monthlymeetschedule;
